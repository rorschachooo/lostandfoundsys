...
<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-popconfirm title="are you sure you want to delete?" @confirm="confirmDelBatch" v-if="auths.includes('member.deleteBatch')">
        <template #reference>
      ...
      <el-table-column prop="phone" label="phone number"></el-table-column>
        ...
        <el-table-column label="operate" width="220">
          <template #default="scope">
            ...
            <el-popconfirm title="are you sure you want to delete?" @confirm="del(scope.row.id)" v-if="auths.includes('member.delete')">
              <template #reference>
