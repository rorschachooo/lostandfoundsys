...
const handleImportSuccess = (res) => {
  ...
  ElMessage.success("Uploaded avatar successfully")
}
...
<template>
  <div style="width: 40%;margin-top: 30px;">
    <span style="font-size: 22px;text-align: center;line-height: 80px;"><h3>Modify personal information</h3></span>
    <el-form style="width: 80%; margin: 0 auto" label-width="60px">
      ...
      <el-form-item label="Reset Account" style="margin-top: 20px;" label-width="250px;">
        <el-input v-model="state.form.username" disabled></el-input>
      </el-form-item>
      <el-form-item label="Revise Email" label-width="250px;">
