  ...
  <div>
    ...
    <div style="width:85%;margin: 0 auto;margin-bottom: 50px;">
        <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;">
          <span style="font-size: 14px;margin-right: 20px;">Current location: Home> Lost property information</span>
        </div>

        <div style="padding-bottom: 15px ;border-bottom: 3px solid #FF9900; text-align: left;display: flex;">
          <span style="font-weight: bold; font-size: 24px;float: left;flex: 3;color: #FF9900;">Lost property information</span>

          <div style="margin-top: 10px;float: right;flex: 1;">
            <el-input style="width: 200px" placeholder="QueryLost property information" v-model="state.searchKey" clearable></el-input>
      ...
      <div style="display:flex;">
        <div style="padding-bottom: 15px ;margin-top: 20px;text-align: left;line-height: 30px;flex: 1;margin-right: 10px;">
          <div style="margin-right: 10px;" class="categorybar">
            <a href="javascript:void(0)" @click="getCategory('all')">All Lost property information</a>
          </div>
            ...
            <div>
              <el-row :gutter="10">
                <el-col :span="6" v-for="item in state.tableData" :key="item.id" style="margin-top: 20px;">
                    <div ><img @click="router.push('/front/lost-detail?id=' + item.id)" :src="item.img" alt="" style="width: 95%; height: 180px;cursor: pointer;"></div>
