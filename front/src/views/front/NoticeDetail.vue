...
<template>
  <div>
    ...
    <div style="width:85%;margin: 0 auto;margin-bottom: 50px;">
        ...
        <div style="padding-bottom: 15px ;border-bottom: 3px solid #FF9900; margin-top: 20px;text-align: center;">
        ...
        <div style="padding-bottom: 15px ;border-bottom: 1px solid #ddd; margin-top: 20px;text-align: center;">
          <span style="font-size: 14px;margin-right: 20px;">Creation time:{{ state.data.createTime }}</span>
        </div>
